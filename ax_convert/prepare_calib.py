...
class MiniCPMV(torch.nn.Module):
    ...
    @torch.no_grad()
    def get_vllm_embedding(self, data, batch_i):
        if 'vision_hidden_states' not in data:
            ...
            if all_pixel_values:
                ...
                if B > vision_batch_size:
                    ...
                    np.save(f"calib_siglip_data/data_{batch_i}.npy", siglip_inputs)
                    calib_siglip_tarfile.add(f"calib_siglip_data/data_{batch_i}.npy")
                ...
                np.save(f"calib_resampler_data/data_{batch_i}.npy", resampler_inputs)
                calib_resampler_tarfile.add(f"calib_resampler_data/data_{batch_i}.npy")
...
if  __name__ == '__main__':
    ...
    img_dir = "/data/wangjian/project/MiniCPM-o/ax_convert/demo_jpegs"
    ...
    for batch_i, img_path in tqdm(enumerate(os.listdir(img_dir))):
        ...
        model_inputs["inputs_embeds"], vision_hidden_states = model.get_vllm_embedding(model_inputs, batch_i)
